...
import 'sign_in_users_model.dart';
export 'sign_in_users_model.dart';

class SignInUsersWidget extends StatefulWidget {
  const SignInUsersWidget({super.key});

  @override
  State<SignInUsersWidget> createState() => _SignInUsersWidgetState();
}

class _SignInUsersWidgetState extends State<SignInUsersWidget> {
  late SignInUsersModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SignInUsersModel());
        ...
        body: SafeArea(
          ...
          child: Stack(
            children: [
              Align(
                ...
                child: Stack(
                  children: [
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          if (valueOrDefault(
                            ...
                            context.pushNamedAuth(
                                'HomePageCaregiver', context.mounted);
                          }
                    ...
                    Align(
                      alignment: const AlignmentDirectional(0.53, 0.64),
                      child: Text(
                        'ليس لديك حساب؟',
                        textAlign: TextAlign.end,
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
              ...
              Align(
                alignment: const AlignmentDirectional(-0.51, 0.64),
                child: InkWell(
                  splashColor: Colors.transparent,
                  focusColor: Colors.transparent,
                  hoverColor: Colors.transparent,
