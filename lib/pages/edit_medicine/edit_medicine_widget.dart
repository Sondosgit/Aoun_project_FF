                            ...
                            Padding(
                              ...
                              child: Stack(
                                children: [
                                  ...
                                  Align(
                                    alignment: const AlignmentDirectional(1.0, -0.54),
                                    child: InkWell(
                              ...
                              child: SingleChildScrollView(
                                child: Column(
                                  ...
                                  children: [
                                    Align(
                                      alignment:
                                          const AlignmentDirectional(0.95, -0.73),
                                      child: Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            0.0, 0.0, 0.0, 11.0),
                                        child: Text(
                                    ...
                                    Align(
                                      alignment:
                                          const AlignmentDirectional(0.0, -0.58),
                                      child: Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            8.0, 0.0, 8.0, 0.0),
                                        child: TextFormField(
                                          controller:
                                              _model.medNameUpTextController ??=
                                                  TextEditingController(
                                            text: editMedicineMediceneRecord
                                                .medName,
                                          ),
                                          ...
                                          validator: _model
                                              .medNameUpTextControllerValidator
                                              .asValidator(context),
                                        ),
                                      ),
                                    ),
                                    Align(
                                      alignment:
                                          const AlignmentDirectional(0.88, -0.35),
                                      child: Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            0.0, 22.0, 0.0, 11.0),
                                        child: Text(
                                    ...
                                    Align(
                                      alignment:
                                          const AlignmentDirectional(0.1, -0.22),
                                      child: FlutterFlowDropDown<String>(
                                        controller:
                                            _model.doseUpValueController ??=
                                                FormFieldController<String>(
                                          _model.doseUpValue ??=
                                              editMedicineMediceneRecord
                                                  .medDose,
                                        ),
                                        options: const [
                                          '💊   جرعة                                                                  ',
                                    ...
                                    Align(
                                      alignment:
                                          const AlignmentDirectional(0.88, 0.0),
                                      child: Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            0.0, 22.0, 0.0, 11.0),
                                        child: Text(
                                    ...
                                    Align(
                                      alignment:
                                          const AlignmentDirectional(0.87, 0.39),
                                      child: Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            0.0, 22.0, 0.0, 11.0),
                                        child: Text(
                                    ...
                                    Align(
                                      alignment:
                                          const AlignmentDirectional(-0.3, 0.55),
                                      child: FlutterFlowDropDown<String>(
                                        multiSelectController: _model
                                                .repUpValueController ??=
                                ...
                                onPressed: () async {
                                  await widget.medEditRef!.update({
                                    ...createMediceneRecordData(
                                      medName:
                                          _model.medNameUpTextController.text,
