...
import 'edit_profile_elderly_model.dart';
export 'edit_profile_elderly_model.dart';

class EditProfileElderlyWidget extends StatefulWidget {
  const EditProfileElderlyWidget({
    super.key,
  ...
  @override
  State<EditProfileElderlyWidget> createState() =>
      _EditProfileElderlyWidgetState();
}

class _EditProfileElderlyWidgetState extends State<EditProfileElderlyWidget> {
  late EditProfileElderlyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditProfileElderlyModel());
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final editProfileElderlyUsersRecord = snapshot.data!;
                          ...
                          child: Builder(
                            builder: (context) => Padding(
                              ...
                              child: FFButtonWidget(
                                ...
                                text: editProfileElderlyUsersRecord.displayName,
                                icon: const Icon(
                                  Icons.mode_edit_sharp,
                          ...
                          child: Builder(
                            builder: (context) => Padding(
                              ...
                              child: FFButtonWidget(
                                ...
                                text: editProfileElderlyUsersRecord.email,
                                icon: const Icon(
                                  Icons.mode_edit_sharp,
                                  color: Color(0xFF4C4D7B),
                                  size: 22.0,
