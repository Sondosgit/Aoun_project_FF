        ...
        body: SafeArea(
          ...
          child: Stack(
            children: [
              Align(
                ...
                child: Stack(
                  children: [
                        ...
                        onPressed: () async {
                          ...
                          await UsersRecord.collection
                              ...
                              .update(createUsersRecordData(
                                ...
                                displayName: _model.nameeEETextController.text,
                    ...
                    Align(
                      alignment: const AlignmentDirectional(0.93, -0.78),
                      child: Text(
                        ' . . مرحباً بك ',
                    ...
                    Align(
                      alignment: const AlignmentDirectional(0.85, -0.65),
                      child: Text(
                        'تسجيل جديد',
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              fontFamily: 'Readex Pro',
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: TextFormField(
                          ...
                          textAlign: TextAlign.end,
                          validator: _model.nameeEETextControllerValidator
                              .asValidator(context),
                        ),
                      ),
                    ),
              ...
              Align(
                alignment: const AlignmentDirectional(0.99, -0.91),
                child: InkWell(
