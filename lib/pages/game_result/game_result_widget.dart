                ...
                child: AuthUserStreamWidget(
                  builder: (context) => StreamBuilder<List<ExerciseRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<ExerciseRecord> iconExerciseRecordList =
                          snapshot.data!;
                      // Return an empty Container when the item does not exist.
                      if (snapshot.data!.isEmpty) {
                        return Container();
                      }
                      final iconExerciseRecord =
                          iconExerciseRecordList.isNotEmpty
                              ? iconExerciseRecordList.first
                              : null;
                      return InkWell(
                        ...
                        onTap: () async {
                          await iconExerciseRecord!.reference
